...
/* Private defines -----------------------------------------------------------*/
#define BRAKE_PRES_Pin GPIO_PIN_0
#define BRAKE_PRES_GPIO_Port GPIOA
#define TANK_PRES_Pin GPIO_PIN_1
#define TANK_PRES_GPIO_Port GPIOA
#define SD_Status_Pin GPIO_PIN_2
...
#define ACT1_En_Pin GPIO_PIN_7
#define ACT1_En_GPIO_Port GPIOA
#define ACT2_En_Pin GPIO_PIN_0
#define ACT2_En_GPIO_Port GPIOB
